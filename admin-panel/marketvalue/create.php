<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        do{
            if(empty($pro_name) || empty($pro_id) || empty($district) || empty($sub_district) || empty($price)){
                $errormsg = "All fields are required";
            }
            else{
                $sql = mysqli_query($db,"INSERT INTO `marketvalue`(`pro_name`, `pro_id`, `district`, `subdistrict`, `price`) VALUES ('$pro_name','$pro_id','$district','$sub_district','$price')");
                if($sql){
            ...
            <div class="content">
                ...
                <form action="#" method="post">
                    <div>
                        ...
                        <input type="text" name="pro_name" class="text-input">
                    </div>
                    <div>
                        <label>Product ID</label>
                        <input type="text" name="pro_id" class="text-input">
                    </div>
                    <div>
                        <label>District</label>
                        <select id="city" name="district" class="input">
                    ...
                    <div>
                        ...
                        <select id="city" name="sub_district" class="input">
                    ...
                    <div>
                        ...
                        <input type="text" name="price" id="" class="text-input">
                    </div>
                    <div>
