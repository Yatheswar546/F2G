    ...
    <div class="main">
        ...
        <div class="admin-content">
            <!-- <div class="button-group">
                <a href="./create.html" class="admin-btn btn-blg">add farmer</a>
                <a href="./index.php" class="admin-btn btn-blg">manage farmer</a>
            </div> -->

            <div class="content">
                <h2 class="page-title">FARMER REGISTRATIONS</h2>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $farmers = mysqli_query($db,"SELECT * FROM `farmers`");
                            if(!$farmers){
