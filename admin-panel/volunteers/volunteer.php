    ...
    <div class="main">
        ...
        <div class="admin-content">
            <!-- <div class="button-group">
                <a href="./create.html" class="admin-btn btn-blg">add volunteer</a>
                <a href="./index.php" class="admin-btn btn-blg">manage volunteer</a>
            </div> -->

            <div class="content">
                <h2 class="page-title">VOLUNTEER REGISTRATIONS</h2>
                ...
                <table>
                    ...
                    <?php
                        // read data from volunteers table
                        $volunteers = mysqli_query($db,"SELECT * FROM `volunteers`");
                        if(!$volunteers){
