<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        $result  = mysqli_query($db,"SELECT * FROM volunteers WHERE volunteer_id = '$volid'");
...
<head>
  ...
  <script type="text/javascript" src="../javascript/script.js"></script>
    ...
    <link rel="stylesheet" href="../css/volunteer-login.css">
...
<body>
    ...
    <form action="#" method="post">
        <div class="container">
            <div class="box">
                <h3 style="font-weight: bold;color: rgb(18, 18, 18);">VOLUNTEER LOGIN</h3>

                <div class="para-3">farmer click here <a href="../templates/farmer-login.php" style="color: blue;"><br>Login here</a>

                </div>

                <div class="input_box">
                    <input type="text" name="volid" class="name" id="usrid" required>
                    <label style="color: #0000009e;">VolunteerID</label>
                ...
                <div class="input_box">
                    <input type="text" name="otp" class="otp" id="otp" required>
                ...
                <div class="input_box">
                    ...
                    <input type="submit" class="signup_button" id="logon" value="LOGIN">

                </div>
                <p class="para-2">
                    Does not have an account?<a href="../templates/volunteer-register.html" style="color: blue;">Register here</a>
                </p>
    ...
    <!-- <script src="../javascript/volunteer-login.js"></script> -->
</body>
